module.exports = function ({ sessionValidation, bandRepository, bandValidation, errorGenerator }) {  
    return {
        createBand: function (accountnameBandLeader, bandName, bandBio, callback) {
            ...
            if (bandNamevalidationErrors.length > 0) {
                ...
                bandRepository.createBand(accountnameBandLeader, bandName, bandBio, function (error, bandId) {
                    if (error) {
